...
const Register = () => {
  ...
  const isProfessorRequest = searchParams.get('professor') === 'true';
  ...
  const [formData, setFormData] = useState({
    ...
    phone: '',
    birthDate: '',
    requestProfessorRole: isProfessorRequest,
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({
        ...
        requestProfessorRole: formData.requestProfessorRole,
      });
      
      toast({
        title: 'Conta criada com sucesso!',
        description: formData.requestProfessorRole 
          ? 'Sua solicitação de perfil professor será analisada pela equipe.'
          : 'Bem-vindo ao Instituto Hudson Paixão!',
      });
      navigate('/');
    } catch (error: any) {
      toast({
          ...
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {isProfessorRequest 
                ...
                : 'Comece a estudar gratuitamente hoje mesmo'
              }
            </CardDescription>
          </CardHeader>
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-start space-x-2 pt-2">
                <Checkbox
                  id="professor"
                  checked={formData.requestProfessorRole}
                  onCheckedChange={(checked) => 
                    setFormData((prev) => ({ ...prev, requestProfessorRole: !!checked }))
                  }
                  disabled={isLoading}
                />
                <div className="grid gap-1.5 leading-none">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Sua solicitação será analisada pela equipe do Instituto.
                  </p>
                </div>
              </div>
            </CardContent>
